...
hashtags_full_df=hashtags_full_df.drop("urls_id","hashtags_id","mentions_id",'annotations_id','lang','created_at','text','partition_0','partition_1','partition_2','partition_3')
...
hashtags_full_df.write.mode('append').parquet(s3_bucket)
...
annotations_full_df=annotations_full_df.drop("urls_id","hashtags_id","mentions_id",'annotations_id','lang','created_at','text','partition_0','partition_1','partition_2','partition_3')
#Save the resulting table of hashtags in S3: 
entity_type='annotations'
prefix=f'{environment}/tweet_entities/{entity_type}/{datetime.date.today().year}/{datetime.date.today().month}/{datetime.date.today().day}/{datetime.datetime.now().hour}/{datetime.datetime.now().minute}'
s3_bucket=f's3://{bucket}/{prefix}/'
annotations_full_df.write.mode('append').parquet(s3_bucket)
...
mentions_full_df=mentions_full_df.drop("urls_id","hashtags_id","mentions_id",'annotations_id','lang','created_at','text','partition_0','partition_1','partition_2','partition_3')
#Save the resulting table of hashtags in S3: 
entity_type='mentions'
prefix=f'{environment}/tweet_entities/{entity_type}/{datetime.date.today().year}/{datetime.date.today().month}/{datetime.date.today().day}/{datetime.datetime.now().hour}/{datetime.datetime.now().minute}'
s3_bucket=f's3://{bucket}/{prefix}/'
mentions_full_df.write.mode('append').parquet(s3_bucket)
...
urls_full_df=urls_full_df.drop("urls_id","hashtags_id","mentions_id",'annotations_id','lang','created_at','text','partition_0','partition_1','partition_2','partition_3')
#Save the resulting table of hashtags in S3: 
entity_type='urls'
...
prefix=f'{environment}/tweet_entities/{entity_type}/{datetime.date.today().year}/{datetime.date.today().month}/{datetime.date.today().day}/{datetime.datetime.now().hour}/{datetime.datetime.now().minute}'
s3_bucket=f's3://{bucket}/{prefix}/'
urls_full_df.write.mode('append').parquet(s3_bucket)
